...
// --- Tiptap UI ---
import { TypographyBubbleMenu } from "@/components/tiptap-ui/typography-bubble-menu"

// --- Extension ---
import { FontSize } from "@/components/tiptap-extension/font-size-extension"
import { TextBlockTypography } from "@/components/tiptap-extension/text-block-typography-extension"
...
export function SimpleEditor({ initialContent, onUpdate }: SimpleEditorProps) {
  ...
  useEffect(() => {
    ...
    const emit = () => onUpdate(editor.getHTML())
    emit()
  ...
  return (
    <div className="simple-editor-wrapper">
      <EditorContext.Provider value={{ editor }}>
        ...
        <TypographyBubbleMenu editor={editor} />
